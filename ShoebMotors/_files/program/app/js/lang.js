...
'অনলাইন থেকে ফিরিয়ে আনুন': 'Restore from online',
    ...
    'কেনাকাটার হিসাব': 'Purchase history', 'পণ্য নির্বাচন': 'Select product', 'আগের বকেয়া': 'Previous due', '＋ আগের বকেয়া': '+ Previous due', 'পুরোনো হিসাবের বাকি': 'Due from old records', 'আগের বকেয়া যোগ করুন': 'Add previous due', 'আগের বকেয়া বদলান': 'Edit previous due', 'জমা সেভ করুন': 'Save payment', 'আগের বকেয়া যোগ করবেন?': 'Add previous due?', 'হ্যাঁ, যোগ করুন': 'Yes, add', 'জমার তারিখ': 'Payment date', 'আগের বকেয়া (না থাকলে খালি রাখুন)': 'Previous due (leave blank if none)', 'আগের বকেয়ার নোট': 'Previous due note', 'টাকা জমা — আগের বকেয়া': 'Take payment — previous due', 'বেশি বিক্রয়মূল্য': 'Highest sales value', 'বেশি লাভ': 'Highest profit', 'বেশি পরিমাণ': 'Highest quantity', 'মোট ও ইনভয়েস': 'Total & invoice', 'জমা': 'Paid', 'বকেয়া জমা': 'Pay due', 'টায়ারের সাইজ': 'Tyre size', 'ফোন': 'Phone',
