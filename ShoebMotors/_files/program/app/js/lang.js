...
'অনলাইন থেকে ফিরিয়ে আনুন': 'Restore from online',
    ...
    'কেনাকাটার হিসাব': 'Purchase history', 'পণ্য নির্বাচন': 'Select product', 'আগের বকেয়া': 'Previous due', '＋ আগের বকেয়া': '+ Previous due', 'পুরোনো হিসাবের বাকি': 'Due from old records', 'আগের বকেয়া যোগ করুন': 'Add previous due', 'আগের বকেয়া বদলান': 'Edit previous due', 'জমা সেভ করুন': 'Save payment', 'আগের বকেয়া যোগ করবেন?': 'Add previous due?', 'হ্যাঁ, যোগ করুন': 'Yes, add', 'ইনভয়েস ▾': 'Invoice ▾', 'ইনভয়েস দেখুন (A4)': 'View invoice (A4)', 'A5 ইনভয়েস': 'A5 invoice', '🧾 থার্মাল প্রিন্ট (80mm)': '🧾 Thermal print (80mm)', '🗑 ইনভয়েস মুছে ফেলুন': '🗑 Delete invoice', '＋ ক্যাশ': '+ Cash', 'ইনভয়েস দেখুন': 'View invoice', 'আরও ▾': 'More ▾', 'নতুন সাপ্লায়ার': 'New supplier', '＋ নতুন সাপ্লায়ার': '+ New supplier', 'মোট দিয়েছি': 'Total paid', 'দিয়েছি': 'Paid', 'বাকি (দিতে হবে)': 'Due (to pay)', 'মোট বাকি (দিতে হবে)': 'Total due (to pay)', 'শেষ কেনা': 'Last purchase', 'টাকা দিন': 'Pay', 'কেনা মাল': 'Goods bought', 'দেওয়া টাকা': 'Payments made', 'অগ্রিম দেওয়া': 'Paid in advance', 'সাপ্লায়ারের তথ্য বদলান': 'Edit supplier', '— সাপ্লায়ার নেই —': '— No supplier —', 'নতুন সাপ্লায়ারের নাম': 'New supplier name', 'সাপ্লায়ারকে এখন দিলেন': 'Paid to supplier now', 'মোট দাম': 'Total price', 'কত টাকা দিলেন': 'Amount paid', 'পুরো বাকি': 'Full due', 'কোনো সাপ্লায়ার নেই।': 'No suppliers yet.', 'আগের বাকি': 'Previous due', '＋ আগের বাকি': '+ Previous due', 'আগের বাকি যোগ করুন': 'Add previous due', 'আগের বাকি বদলান': 'Edit previous due', 'আগের বাকি যোগ করবেন?': 'Add previous due?', 'আজকের সংক্ষিপ্ত হিসাব': 'Today at a glance', 'বিক্রি হওয়া মাল': 'Items sold', 'আজকের বিলে বাকি': 'Due on today’s bills', 'পুরোনো বাকি আদায়': 'Old dues collected', 'নতুন কাস্টমার': 'New customers', 'সবচেয়ে বেশি বিক্রি': 'Top seller', 'মেয়াদ পার হওয়া বাকি': 'Overdue dues', 'মোট পাওনা (সব কাস্টমার)': 'Total receivable (all customers)', 'জমার তারিখ': 'Payment date', 'আগের বকেয়া (না থাকলে খালি রাখুন)': 'Previous due (leave blank if none)', 'আগের বকেয়ার নোট': 'Previous due note', 'টাকা জমা — আগের বকেয়া': 'Take payment — previous due', 'বেশি বিক্রয়মূল্য': 'Highest sales value', 'বেশি লাভ': 'Highest profit', 'বেশি পরিমাণ': 'Highest quantity', 'মোট ও ইনভয়েস': 'Total & invoice', 'জমা': 'Paid', 'বকেয়া জমা': 'Pay due', 'টায়ারের সাইজ': 'Tyre size', 'ফোন': 'Phone',
